...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden pt-10 pb-24 md:pt-14">
      ...
      />
      <div className="absolute -top-40 left-1/2 h-72 w-xlnslate-x-1/2 rounded-full bg-primary/20 blur-[120px] animate-glow-pulse" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
          ...
          <div className="flex items-center justify-center order-last mt-10 lg:order-0 lg:mt-0">
            <div className="relative w-full max-w-xs aspect-square sm:max-w-sm lg:max-w-md">
              ...
              <div className="absolute inset-6 rounded-[28px] border border-primary/30 bg-background/40 shadow-[0_0_40px_rgba(34,197,94,0.25)] overflow-hidden">
                <model-viewer
            ...
            <div className="animate-marquee flex items-center gap-6 pr-6">
              {marqueeLogos.map((logo, index) => (
                <div
                  ...
                  className="animate-float-slow flex items-center justify-center rounded-xl border border-border/50 bg-background/80 px-8 py-5 shadow-sm md:py-6"
